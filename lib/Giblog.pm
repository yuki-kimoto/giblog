...
EOS
  ...
  $self->create_file($templates_common_meta_file);
  my $templates_common_meta = $self->common_meta;
  $self->write_to_file($templates_common_meta_file, $templates_common_meta);
